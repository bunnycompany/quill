...
enum Migrations {
    ...
    static let all: [String] = [
        ...
        """,
        // v2 -> v3: cross-meeting speaker recognition.
        // NOTE: voice profiles are biometric data; local-only, deletable.
        // `centroid` is a raw little-endian Float32 array (L2-normalized).
        """
