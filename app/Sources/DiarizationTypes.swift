...
public struct DiarizedTranscript: Sendable {
    ...
    /// Final per-cluster embedding centroids, keyed by the relabeled 1-based
    /// speaker ID ("Speaker 1" -> key 1). Used for voice recognition.
    public let speakerCentroids: [Int: [Float]]
